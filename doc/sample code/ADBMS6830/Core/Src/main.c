...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	...
	HAL_Delay(500);
	HAL_UART_Transmit(&huart3, (uint8_t*) "started", 8, 100);
...
//		if (adBms6830_open_wire_detection(total_ic, &ic[0]) == HAL_ERROR)
//			printf("yarra beni balans\n");
//
//		else
//			printf("balans oke\n");
//
...
//			if (ic[icCounter].TempOpenWire!=0)printf("yarra beni temp\n");
//			else printf("temp oke\n");
//		}
//		printf("\n");
//
...
//	  printStatus(total_ic,&ic[0],Status, C);
//
...
//
//
//		for(uint8_t cellcountera=0;cellcountera<12;cellcountera++){
//			ic[0].PwmA.pwma[cellcountera]=0x0F;
//			adBmsWakeupIc[total_ic];
//	        adBmsWriteData(total_ic, &ic[0], WRCFGB, Config, B);
//			adBmsWriteData(total_ic, &ic[0], WRPWM1, Pwm, A);
//			ic[0].PwmA.pwma[cellcountera]=0;
//			adBmsReadData(total_ic, &ic[0], RDPWM1, Pwm, A);
//			printf("cell%d:%d\n",cellcountera+1,ic[0].PwmA.pwma[cellcountera]);
//			ic[0].PwmA.pwma[cellcountera]=0;
//			HAL_Delay(500);
//		}
//		adBmsWakeupIc[total_ic];
//		adBmsWriteData(total_ic, &ic[0], WRCFGB, Config, B);
//	    adBmsWriteData(total_ic, &ic[0], WRPWM1, Pwm, A);
//		for(uint8_t cellcountera=0;cellcountera<4;cellcountera++){
//			ic[0].PwmB.pwmb[cellcountera]=0x0F;
//			adBmsWakeupIc[total_ic];
//			adBmsWriteData(total_ic, &ic[0], WRCFGB, Config, B);
//			adBmsWriteData(total_ic, &ic[0], WRPWM2, Pwm, B);
//			ic[0].PwmB.pwmb[cellcountera]=0;
//			adBmsReadData(total_ic, &ic[0], RDPWM2, Pwm, B);
//			printf("cell%d:%d\n",cellcountera+13,ic[0].PwmB.pwmb[cellcountera]);
//			ic[0].PwmB.pwmb[cellcountera]=0;
//			HAL_Delay(500);
//
//		}
...
void HAL_ADC_ConvCpltCallback(ADC_HandleTypeDef *hadc) {
	...
	volt_bc = ((double) adc_data[0] - 56.15) / 5.083;
	volt_ac = ((double) adc_data[1] - 56.15) / 5.083;
}
